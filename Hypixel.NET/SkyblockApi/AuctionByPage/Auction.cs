...
namespace Hypixel.NET.SkyblockApi
{
    public class Auction
    {
        ...
        [JsonProperty("item_bytes")] public string ItemBytes { get; private set; }

        [JsonProperty("claimed")] public bool Claimed { get; private set; }

        [JsonProperty("claimed_bidders")] public List<object> ClaimedBidders { get; private set; }

        [JsonProperty("highest_bid_amount")] public long HighestBidAmount { get; private set; }

        [JsonProperty("bids")] public List<Bids> Bids { get; private set; }
    }
}